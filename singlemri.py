...
#     output = subprocess.check_output(["/app/dicom_hdr", dicom_file])
...
#                 print("Copied", dicom_file, "to", output_folder)
...
def get_file_type(dicom_file):
    ...
    # Feel free to adjust this based on your specific criteria for sorting
