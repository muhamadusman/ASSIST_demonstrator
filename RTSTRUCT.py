...
# # Load the mask file
# mask_nifti = nib.load('tmp_segmentation_corrected.nii')
...
# print("Rearranged mask shape:", rearranged_mask_array.shape)

# # Flip vertically the first two dimensions
# flipped_mask_array = np.flipud(rearranged_mask_array)
# print("Flipped mask shape:", flipped_mask_array.shape)

# # Rotate the first two dimensions 90 degrees anticlockwise
# rotated_mask_array = np.rot90(flipped_mask_array, 1, axes=(0, 1))
# print("Final mask shape after rotation:", rotated_mask_array.shape)

# # Create a new RT Struct
# rtstruct = RTStructBuilder.create_new(dicom_series_path="./singlemri")
